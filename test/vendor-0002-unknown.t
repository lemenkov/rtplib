...
main(_) ->
	...
	BinRtcpRrSdesBye3 = <<128,201,0,1,15,159,200,54,129,202,0,7,15,159,200,
	...
	etap:is(BinRtcpRrSdesBye3, rtcp:encode([RtcpRr3, RtcpSdes3, RtcpBye3]), "Check what we could reproduce previous packet from RR+SDES+BYE"),

	% Another quite complex RTCP packet with coupled RR, SDES and BYE
	% SDES packet contains 'priv' extension
	BinRtcpRrSdesBye4 = <<128,200,0,6,55,82,152,102,209,215,221,218,198,102,
