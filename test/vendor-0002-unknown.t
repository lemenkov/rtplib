...
main(_) ->
	...
	% This one was damaged - first octet was 1 instead of 129 - I fixed it for this test
	%               -=1=-
	BinRtcpSdes1 = <<129,202,0,17,0,0,123,112,1,61,70,68,66,66,48,66,52,67,
	...
	% Another broken SDES
	%               -=1=-
	BinRtcpSdes2 = <<129,202,0,2,0,0,120,143,0,0,0,0>>,
	{ok, [RtcpSdes2]} = rtcp:decode(BinRtcpSdes2),
	etap:is(BinRtcpSdes2, rtcp:encode(RtcpSdes2), "Check that we can reproduce original RTCP sdes"),
