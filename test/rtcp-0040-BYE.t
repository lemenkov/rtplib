...
main(_) ->
	...
	etap:fun_is(fun ([#bye{message = Message, ssrc = SSRCs}]) when is_list(SSRCs), is_list(Message) -> true; (_) -> false end, rtcp:decode(Data), "Simple decoding BYE RTCP data stream and returning a list with only member - record"),
